...
1. [Usage](#usage)
  ...
  2. [API](#api)
    ...
    2. [Comparators](#comparators)
      1. [isGreaterThan](#isgreaterthan---bolean)
      2. [isGreaterThanOrEqual](#isgreaterthanorequal---bolean)
      3. [isLessThan](#islessthan---bolean)
      4. [isLessThanOrEqual](#islessthanorequal---bolean)
      5. [isEqual](#isequal---bolean)
    3. [Getters](#getteres)
